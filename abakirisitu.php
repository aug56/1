...
<div class="body"><br>
<center>
	<center><br><br><label class="intro">URUTONDE  RW'ABAKIRISITU</label><br><br>

	<table border="1" width="90%">
		<tr>
			<th>Id</th>
			<th>Amazina</th>
			<th width="140">Igitsina</th>
			<th width="140">Akarere</th>
			<th width="140">Umurenge</th>
			<th width="220">Ibikorwa</th>
		</tr>

		<?php 

include 'connect.php';
$select=mysqli_query($con,"select * from abakirisitu");
while ($row=mysqli_fetch_assoc($select)) {
	$id=$row['id'];
	$name=$row['amazina'];
	$gender=$row['igitsina'];
	$district=$row['akarere'];
	$sector=$row['umurenge'];
	...
	<td>$sector</td>
	<td>&nbsp;
		<a href='updatea.php? updateid=$id'><button class='update'>Gokosora</button></a>
		<a href='deletea.php? deleteid=$id'><button class='delete'>Gusiba</button></a>
	</td>
</tr>
	";
}
